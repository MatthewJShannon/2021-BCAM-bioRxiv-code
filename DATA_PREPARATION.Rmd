...
sample1 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P1")

# Read in the respective velocity data
          ldat1            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/1_12weeks.loom")
...
sample2 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P2")

# Read in the respective velocity data
          ldat2            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/2_12weeks.loom")
...
sample3 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P3")

# Read in the respective velocity data
          ldat3            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/3_6weeks.loom")
...
sample4 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P4")

# Read in the respective velocity data
          ldat4            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/4_6weeks.loom")
...
sample5 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P5")

# Read in the respective velocity data
          ldat5            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/sc244_6w.loom")
...
sample6 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P6")

# Read in the respective velocity data
          ldat6            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/sc295_6w.loom")
...
sample7 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/1_Beristain/P7")

# Read in the respective velocity data
          ldat7            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/sc899_12w.loom")
...
sample8 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/P9")

# Read in the respective velocity data
          ldat8            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7196226.loom")
...
sample9 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/P10.1")

# Read in the respective velocity data
          ldat9            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7474064.loom")
...
sample10 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/P10.2")

# Read in the respective velocity data
          ldat10            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7474065.loom")
...
sample11 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/P11")

# Read in the respective velocity data
          ldat11            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7474068.loom")
...
sample12 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/P12")

# Read in the respective velocity data
          ldat12            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7511884.loom")
...
sample13 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D6/CD45-")

# Read in the respective velocity data
          ldat13            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7167223.loom")
...
sample14 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D6/CD45+.1")

# Read in the respective velocity data
          ldat14            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7167219.loom")
...
sample15 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D6/CD45+.2")

# Read in the respective velocity data
          ldat15            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7167224.loom")
...
sample16 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D9/CD45-")

# Read in the respective velocity data
          ldat16            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7196225.loom")
...
sample17 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D9/CD45+")

# Read in the respective velocity data
          ldat17            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7196224.loom")
...
sample18 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D10/CD45-")

# Read in the respective velocity data
          ldat18            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7474063.loom")
...
sample19 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D10/CD45+")

# Read in the respective velocity data
          ldat19            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7474062.loom")
...
sample20 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D12/CD45-")

# Read in the respective velocity data
          ldat20            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7511882.loom")
...
sample21 <- Read10X            (data.dir = "~/Desktop/HARDRIVE/2_Vento-Tormo/D12/CD45+")

# Read in the respective velocity data
          ldat21            <- ReadVelocity ("~/Desktop/HARDRIVE/5_scVelo/FCA7511881.loom")
...
pdf      ("vel_interface_clusttree.pdf", width = 15, height = 25)
...
#redo umap / pca
Trophoblasts     <- RunPCA        (object = Trophoblasts, npcs       = 50, verbose = FALSE)
...
pdf      ("Trophoblast_clusttree.pdf", width = 15, height = 25)
...
sample22 <- Read10X            (data.dir = "~/Desktop/Undifferentiated/Stem_Cell_Derived/CT27")

# Read in the respective velocity data
          ldat22            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT27.loom")
...
sample22 <- AddMetaData        (object = sample22, metadata = "1",                col.name = "Batch"  )
...
sample23 <- Read10X            (data.dir = "~/Desktop/Undifferentiated/Stem_Cell_Derived/CT29")

# Read in the respective velocity data
          ldat23            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT29.loom")
...
sample23 <- AddMetaData        (object = sample23, metadata = "1",                col.name = "Batch"  )
...
sample24 <- Read10X            (data.dir = "~/Desktop/Undifferentiated/Stem_Cell_Derived/CT30")

# Read in the respective velocity data
          ldat24            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT30.loom")
...
sample24 <- AddMetaData        (object = sample24, metadata = "1",                col.name = "Batch"  )
...
sample25 <- Read10X            (data.dir = "~/Desktop/Differentiated/Stem_Cell_Derived/CT27")

# Read in the respective velocity data
          ldat25            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT27_EVT.loom")
...
sample25 <- AddMetaData        (object = sample25, metadata = "2",              col.name = "Batch"  )
...
sample26 <- Read10X            (data.dir = "~/Desktop/Differentiated/Stem_Cell_Derived/CT29")

# Read in the respective velocity data
          ldat26            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT29_EVT.loom")
...
sample26 <- AddMetaData        (object = sample26, metadata = "2",              col.name = "Batch"  )
...
sample27 <- Read10X            (data.dir = "~/Desktop/Differentiated/Stem_Cell_Derived/CT30")

# Read in the respective velocity data
          ldat27            <- ReadVelocity ("~/Desktop/4_Velocity_Data/TS_Organoids__CT30_EVT.loom")
...
sample27 <- AddMetaData        (object = sample27, metadata = "2",              col.name = "Batch"  )
...
```{r}
# Merge the remaining six trophoblast organoid seurat objects into a second large data file
...
```{r}
# Integrate the data baseed on the "Time" variable
...
pdf      ("stem_organoids_clusttree.pdf", width = 15, height = 25)
...
stemorganoids <- RunUMAP      (stemorganoids, dims       = 1:35)
stemorganoids <- RunTSNE      (stemorganoids, dims       = 1:35)
```

```{r}
# Visualize the trophoblast organoid data by UMAP
UMAPPlot     (object = stemorganoids, label = TRUE, pt.size = 2)                      + NoLegend ()
TSNEPlot     (object = stemorganoids, label = TRUE, pt.size = 2)                      + NoLegend ()
UMAPPlot     (object = stemorganoids, label = TRUE, pt.size = 2, split.by = 'Sex')    + NoLegend ()
UMAPPlot     (object = stemorganoids, label = TRUE, pt.size = 2, split.by = 'State')  + NoLegend ()
UMAPPlot     (object = stemorganoids, label = TRUE, pt.size = 2, split.by = 'Phase')  + NoLegend ()
UMAPPlot     (object = stemorganoids, label = TRUE, pt.size = 2, split.by = 'ID')     + NoLegend ()

# Visualize expression of trophoblast organoid QC metrics by UMAP
FeaturePlot  (object = stemorganoids, features = c("nFeature_RNA"), pt.size = 2, order = TRUE, cols = c("grey", "red"))
FeaturePlot  (object = stemorganoids, features = c("nCount_RNA"),   pt.size = 2, order = TRUE, cols = c("grey", "red"))
FeaturePlot  (object = stemorganoids, features = c("percent.mt"),   pt.size = 2, order = TRUE, cols = c("grey", "red"))
FeaturePlot  (object = stemorganoids, features = c("S.Score"),      pt.size = 2, order = TRUE, cols = c("grey", "red"))
FeaturePlot  (object = stemorganoids, features = c("G2M.Score"),    pt.size = 2, order = TRUE, cols = c("grey", "red"))
```
...
# Label all trophoblast organoid clusters by cell type
       new.cluster.ids        <- c("CTB 2",          # Cytotrophoblast state 2
                                   ...
                                   "CTB 3",          # Cytotrophoblast state 3
                                   "EVT 1",          # Extravillous trophoblast state 1
                                   "cCTB")           # Column cytotrophoblast
names (new.cluster.ids)       <- levels       (stemorganoids)
stemorganoids$seurat_clusters <- Idents       (stemorganoids)
stemorganoids                 <- RenameIdents (stemorganoids, new.cluster.ids)

UMAPPlot (stemorganoids, label = TRUE) + NoLegend ()
```

```{r}
# Save the trophoblast organoid dataset
save (stemorganoids, file = "stem_organoid.Rdata")
```
...
CT27 <- subset (stemorganoids, subset = ID == "CT27")
CT29 <- subset (stemorganoids, subset = ID == "CT29")
CT30 <- subset (stemorganoids, subset = ID == "CT30")
...
pdf      ("CT27_clusttree.pdf", width = 15, height = 25)
...
pdf      ("CT29_clusttree.pdf", width = 15, height = 25)
...
# Remove identified remaining cell doublets
CT29 <- subset (CT29, idents = c("0", "1", "2", "3"))

# Re-do principal component analysis and re-cluster data
CT29 <- RunPCA        (object = CT29, npcs       = 50, verbose = FALSE)
CT29 <- FindNeighbors (object = CT29)
CT29 <- FindClusters  (object = CT29, resolution = resolution.range)

# Determine, again, clustering resolution
clustree (CT29, prefix = "integrated_snn_res.")

# Re-cluster CT29 data
CT29 <- FindClusters  (object = CT29, resolution = 0.35)
# Re-reduce CT29 data dimensionality
CT29 <- RunUMAP       (object = CT29, reduction  = "pca", dims = 1:20)
CT29 <- RunTSNE       (object = CT29, reduction  = "pca", dims = 1:20)
...
# Label all CT29 organoid clusters by cell type
       new.cluster.ids  <- c("EVT",            # Extravillous trophoblast state 1
                             "CTB 1",          # Cytotrophoblast state 1
                             "CTB 2",          # Cytotrophoblast state 2
                             "SCTp",           # Syncytiotrophoblast precursor
                             "cCTB")           # Column cytotrophoblast
...
pdf      ("CT30_clusttree.pdf", width = 15, height = 25)
...
SaveH5Seurat ( CT27,           filename = "CT27.h5Seurat")
Convert      ("CT27.h5Seurat", dest     = "h5ad")
```
...
SaveH5Seurat ( CT29,           filename = "CT29.h5Seurat")
Convert      ("CT29.h5Seurat", dest     = "h5ad")
```
...
SaveH5Seurat ( CT30,           filename = "CT30.h5Seurat")
Convert      ("CT30.h5Seurat", dest     = "h5ad")
```
